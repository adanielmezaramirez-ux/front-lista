...
import { Clase, Horario, getDiaSemanaNombre } from '../../interfaces';
...
const SolicitarReprogramacion: React.FC<SolicitarReprogramacionProps> = ({
  ...
  const { getMexicoDateString, getDiaSemanaActual } = useMexicoDateTime();
  ...
  const horariosFuturos = clase?.horarios?.filter(h => {
    // Filtrar horarios que no sean hoy o futuros
